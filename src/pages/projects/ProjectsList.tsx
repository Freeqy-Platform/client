...
export default function ProjectsList() {
    ...
    const fetchProjects = async () => {
        try {
            ...
            const categoryFilter = selectedCategory && selectedCategory !== "all" ? selectedCategory : debouncedSearch;
            if (categoryFilter) filter.Category = categoryFilter;
            if (selectedStatus && selectedStatus !== "all") filter.status = Number(selectedStatus);
            ...
            const data = Array.isArray(response) ? response : (response?.projects || response?.items || response?.value || []);
                ...
                <div className="flex gap-2 w-full md:w-auto flex-wrap">
                    ...
                    <Select value={selectedStatus} onValueChange={setSelectedStatus}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value={ProjectStatus.InProgress.toString()}>In Progress</SelectItem>
